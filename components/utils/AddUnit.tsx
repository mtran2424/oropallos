...
const AddUnit = ({ onAddUnit, product }: {
  ...
  return (
    <>
      ...
      {/* Modal for adding inventory units */}
      <Modal open={addUnit} title="Add Inventory" onClose={closeEventModal} ref={modalRef} height="max-h-[60vh]" width="max-w-2xl">
        {/* Form for adding inventory units */}
