...
import { calculateDiscount, calculateSubtotal, calculateTax, calculateTotal, getDiscount, TransactionItem } from "../global.utils";
...
const CustomerDisplay = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row w-full items-start justify-center divide-x divide-zinc-400">
